...
import { Search, ChevronDown, Filter, ArrowRight, Clock, Award } from 'lucide-react';
...
export default function ClientDashboard({ tasks, onNavigate }) {
  ...
  const filteredTasks = tasks.filter(task => {
    const matchesSearch = !cleanQuery || (task.title || '').toLowerCase().includes(cleanQuery) || (task.category || '').toLowerCase().includes(cleanQuery) || (task.description || '').toLowerCase().includes(cleanQuery);
            ...
            filteredTasks.map((task) => (
              <div 
                ...
                style={{ 
                  ...
                  border: '1px solid #e2e8f0', boxShadow: '0 4px 20px rgba(15, 23, 42, 0.03)'
                }}
              >
                ...
                <div>
                  <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.25rem', fontWeight: 800, color: '#0f172a', margin: '0 0 8px' }}>
                    <HighlightText text={task.title} highlight={cleanQuery} />
                  </h3>
                  {task.description && (
                    <p style={{ margin: 0, fontSize: '0.92rem', color: '#64748b', lineHeight: 1.55 }}>
                      <HighlightText text={task.description} highlight={cleanQuery} />
                    </p>
                  )}
                </div>
